...
//        testBfs();
    ...
    private static void testBfsWay(){
        ...
        System.out.println(graph.findWay("Москва", "Курск"));
        System.out.println(graph.findWay("Москва", "Воронеж"));
        System.out.println(graph.findWay("Воронеж", "Москва"));
    }
